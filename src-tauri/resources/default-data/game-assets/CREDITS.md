...
Drop files into the appropriate subdirectory and hit the **Rescan** button in the app. Hostable runtime clients should invoke the `game_assets_rescan` command through the runtime command API.
